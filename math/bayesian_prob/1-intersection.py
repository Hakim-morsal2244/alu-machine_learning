#!/usr/bin/env python3
"""
Module to calculate the intersection of observed data with
...
def intersection(x, n, P, Pr):
    """
    Calculates the intersection of obtaining data x and n with
    hypothetical probabilities P and prior beliefs Pr.
