#!/usr/bin/env python3
"""
Module that defines the MultiNormal class representing a Multivariate Normal distribution
"""
import numpy as np
...
class MultiNormal:
    ...
    def __init__(self, data):
        ...
        Parameters:
        data (numpy.ndarray): shape (d, n) data set
        ...
        # Calculate covariance manually (d x d)
